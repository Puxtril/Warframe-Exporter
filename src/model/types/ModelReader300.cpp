...
void
ModelReader300::readBody(const ModelHeaderExternal& extHeader, BinaryReader::BinaryReaderBuffered* bodyReader, ModelBodyExternal& outBody)
{
    ModelReader290::getInstance()->readBody(extHeader, bodyReader, outBody);
}