...
{
	class ModelSMReader108 : public ModelReader
	{
		ModelSMReader108() = default;

	public:
		inline static ModelSMReader108* getInstance()
		{
			static ModelSMReader108* instance = new ModelSMReader108();
			return instance;
		}
		...
		inline std::vector<std::tuple<LotusLib::Game, int>> getEnumMapKeys() const override
		{
			std::vector<std::tuple<LotusLib::Game, int>> extTypes = {
				{ LotusLib::Game::SOULFRAME, (int)ModelSMType::MODEL_SM_108 },
				{ LotusLib::Game::SOULFRAME, (int)ModelSMType::MODEL_SM_109 },
			};
			return extTypes;
		}
