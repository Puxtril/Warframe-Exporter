...
namespace WarframeExporter::Material
{
	...
	public:
		...
		void writeOut(const MaterialInternal& materialInternal, const std::filesystem::path& outputPath, LotusLib::PackagesReader& pkgsReader, const LotusLib::LotusPath& filePath);
