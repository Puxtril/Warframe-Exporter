...
void
ModelReader103::readHeader(BinaryReader::Buffered* headerReader, const LotusLib::CommonHeader& header, ModelHeaderExternal& outHeader)
{
...
void
ModelReader103::readBody(const ModelHeaderExternal& extHeader, BinaryReader::Buffered* bodyReaderB, BinaryReader::Buffered* bodyReaderF, ModelBodyExternal& outBody)
{
...
bool
ModelReader103::isMorePhysX(BinaryReader::Buffered* bodyReader)
{
