...
void
VertexColorReader110::readHeaderDebug(BinaryReader::Buffered* headerReader)
{
...
void
VertexColorReader110::readHeader(BinaryReader::Buffered* headerReader, VertexColorHeader& outHeader)
{
...
void
VertexColorReader110::readBody(BinaryReader::Buffered* bodyReader, std::vector<glm::u8vec4>& outData)
{
