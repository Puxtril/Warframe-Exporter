...
void
ModelReader289::readHeaderDebug(BinaryReader::BinaryReaderBuffered* headerReader, const Ensmallening& ensmalleningData, const LotusLib::CommonHeader& header)
{
    ...
    for (uint32_t x = 0; x < subModelCount; x++)
    {
        ...
        headerReader->seek(8, std::ios::cur);
        // 5 floats
        headerReader->seek(4 * 5, std::ios::cur);
        // 3 doubles
        headerReader->seek(8 * 3, std::ios::cur);
        // Just 0s
...
void
ModelReader289::readHeader(BinaryReader::BinaryReaderBuffered* headerReader, const Ensmallening& ensmalleningData, const LotusLib::CommonHeader& header, ModelHeaderExternal& outHeader)
{
...
void
ModelReader289::readBodyDebug(const ModelHeaderExternal& extHeader, BinaryReader::BinaryReaderBuffered* bodyReader)
{
...
void
ModelReader289::readBody(const ModelHeaderExternal& extHeader, BinaryReader::BinaryReaderBuffered* bodyReader, ModelBodyExternal& outBody)
{
    bodyReader->seek(0, std::ios_base::beg);
