...
{
	class ModelReader314 : public ModelReader
	{
		ModelReader314() = default;

	public:
		inline static ModelReader314* getInstance()
		{
			static ModelReader314* instance = new ModelReader314();
			return instance;
		}
		...
		inline std::vector<std::tuple<LotusLib::Game, int>> getEnumMapKeys() const override
		{
			std::vector<std::tuple<LotusLib::Game, int>> extTypes = {
				{ LotusLib::Game::SOULFRAME, (int)ModelPackedType::MODEL_PACKED_314 },
				{ LotusLib::Game::SOULFRAME, (int)ModelPackedType::MODEL_PACKED_315 },
			};
			return extTypes;
		}
