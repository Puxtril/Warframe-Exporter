...
void
LevelStaticReader34::readHeader(BinaryReader::Buffered* headerReader, LevelStaticHeaderExternal& outHeader)
{
    ...
    outHeader.unk64Count = headerReader->readUInt32(0, 10, "Unk64 Count");
    ...
    outHeader.unk3Count = headerReader->readUInt32();
    outHeader.matrixCount = headerReader->readUInt32();
    outHeader.unk4Count = headerReader->readUInt32();
    outHeader.unk5Count = headerReader->readUInt32();
...
void
LevelStaticReader34::readBody(BinaryReader::Buffered* bodyReader, const LevelStaticHeaderExternal& extHeader, LevelStaticBodyExternal& outBody)
{
    outBody.objects.resize(extHeader.vertexCount);

    bodyReader->seek(8 * extHeader.unk64Count, std::ios::beg);
    ...
    bodyReader->seek(extHeader.indices1Count * 4, std::ios::cur);
    ...
    bodyReader->seek(extHeader.unk3Count * 12, std::ios::cur);
