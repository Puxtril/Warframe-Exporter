...
void
ModelReader290::readHeaderDebug(BinaryReader::BinaryReaderBuffered* headerReader, const Ensmallening& ensmalleningData, const LotusLib::CommonHeader& header)
{
    ...
    for (uint32_t x = 0; x < subModelCount; x++)
    {
        ...
        headerReader->seek(8, std::ios::cur);
        // 16 floats
        headerReader->seek(4 * 16, std::ios::cur);
    }
...
void
ModelReader290::readHeader(BinaryReader::BinaryReaderBuffered* headerReader, const Ensmallening& ensmalleningData, const LotusLib::CommonHeader& header, ModelHeaderExternal& outHeader)
{
...
void
ModelReader290::readBodyDebug(const ModelHeaderExternal& extHeader, BinaryReader::BinaryReaderBuffered* bodyReader)
{
