...
namespace WarframeExporter::Audio {
	...
	public:
		...
		void extract(FileEntry& fileEntry, const LotusLib::PackageCollection& pkgs, const LotusLib::PackagesBin& pkgsBin, std::ostream& outStream, ExtractOptions options);
	};
}
