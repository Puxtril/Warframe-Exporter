...
{
	class ModelDCMReader111 : public ModelReader
	{
		ModelDCMReader111() = default;

	public:
		inline static ModelDCMReader111* getInstance()
		{
			static ModelDCMReader111* instance = new ModelDCMReader111();
			return instance;
		}
		...
		inline std::vector<std::tuple<LotusLib::Game, int>> getEnumMapKeys() const override
		{
			std::vector<std::tuple<LotusLib::Game, int>> extTypes = {
				{ LotusLib::Game::SOULFRAME, (int)ModelDCMType::MODEL_DCM_111 },
			};
			return extTypes;
		}
